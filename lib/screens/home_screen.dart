...
import 'components/temp_body.dart';
import 'components/temp_btns.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void setupTyreAnimation() {
    ...
    _animationTyre1Psi = CurvedAnimation(
        parent: _tyreAnimationController, curve: Interval(0.35, 0.5));
                    ...
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: DoorLock(
                          ...
                          press: _controller.updateLefttDoorLock,
                        ),
                      ),
                    ),
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        ...
                        opacity: _controller.selectedBottomTab == 0 ? 1 : 0,
                        child: DoorLock(
                          isLock: _controller.isBonneDoorLock,
                    ...
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        ...
                        child: DoorLock(
                          ...
                          press: _controller.updateTrunktDoorLock,
                        ),
                      ),
                    ),
                    //battery
